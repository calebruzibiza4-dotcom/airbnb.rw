...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Show landing page ONLY at exactly "/" without view=browse parameter
    const isLandingPage = window.location.pathname === '/' && !window.location.search.includes('view=browse');
    setShowLanding(isLandingPage);
  }, []);
  ...
  return (
    <>
      {/* Show landing page only at root path */}
      {showLanding && !listingId ? (
        <Landing />
      ) : (
        // Show browse/listings view with navbar and dashboard
